...
namespace Bank
{
    ...
    class Program
    {
        ...
        public static IBankcs bank = new Bank();
        static void Main(string[] args)
        {
           ...
           // bank.OnWithdraw +=new Bank.DoSomething(Bank_OnWithdraw2);
            ...
            while (option!="8")
            {
                ...
                Console.WriteLine("8. Show account details");
                ...
                switch (option)
                {
                    ...
                    case "4":
                        ...
                        break;
                    case "5":
                        bank.ShowAccountsBiggerSum();
                        break;
                    case "6":
                        bank.DeleteAccount();
                        break;
                    case "7":
                        bank.ChangeUserAdress();
                        break;
                    case "8":
        ...
        private static void ChangeUserAdress()
        {
